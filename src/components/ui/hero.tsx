...
export default function HeroWithTestimonials() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-[#00C950] to-[#007D1F] py-20 md:py-20">
        <div className="container px-4 md:px-4 relative z-10 mt-5">
          {/* Top section with logo and content */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* Left side - Text content */}
            <div className="flex flex-col justify-center space-y-8 pl-0 md:pl-8 lg:pl-12">
              <div className="space-y-8 max-w-xl mx-auto md:mx-0">
                <h1
                  className={`${tiltwarp.className} relative text-2xl font-bold md:text-4xl xl:text-6xl title-head text-center md:text-left z-10 text-white leading-relaxed`}
                ...
                <p
                  className={`${tiltneon.className} text-white text-muted-foreground md:text-xl`}
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/layanan" rel="canonical">
                  <Button
                    size="lg"
                    className={`${tiltwarp.className} px-8 bg-white text-green-500 hover:bg-green-600 hover:text-white transition-colors`}
                  >
                    Layanan Kami
          ...
          <div
            className="w-full mt-12 overflow-hidden rounded-lg bg-blue-50/50 p-3"
            ...
            <div className="overflow-hidden">
              ...
              >
                ...
                {testimonials.map((testimonial) => (
                  ...
                  >
                    <div className="flex flex-col bg-white rounded-lg shadow-sm p-2 h-full">
                      ...
                      <blockquote className="text-black text-xs line-clamp-3">
                        {testimonial.content}
                      </blockquote>
                    </div>
                  </div>
