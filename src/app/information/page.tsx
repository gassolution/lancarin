...
export default function Information() {
  ...
  return (
    <>
      <Head>
        <title>Informasi GAS Solution</title>
        <meta name="description" content="Simak informasi karir dan kompetisi dari GAS Solution!" />
        ...
        <meta property="og:title" content="Informasi GAS Solution" />
        <meta property="og:description" content="Simak informasi karir dan kompetisi dari GAS Solution!" />
