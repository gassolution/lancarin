...
export default function SaluranAir() {
  ...
  return (
    <>
      <Head>
        <title>Jasa Pembersihan Saluran Mampet | Ecofix</title>
      ...
      <main>
        <div className={`${outfit.className} overflow-x-hidden flex flex-col items-center justify-center p-8 pb-20 gap-8 sm:p-20 rounded-xl xl:mx-20`}>
          ...
          <p className="text-md md:text-lg text-center w-full md:w-2/3">
            Ecofix menyediakan layanan solusi saluran mampet atau drain cleaning profesional untuk memastikan saluran pembuangan anda tetap bersih dan bebas sumbatan. Layanan kami meliputi:
          </p>
          <div>
            <SimpleCard_V5>
              <Image
