...
export default function GreaseTrap() {
  ...
  return (
    <>
      <Head>
        <title>Jasa Perawatan Grease Trap | Lancarin</title>
      ...
      <main>
        <div className={`${tiltwarp.className} overflow-x-hidden flex flex-col items-center justify-center p-8 pb-20 gap-8 sm:p-20 rounded-xl xl:mx-20`}>
          ...
          <p className="text-md md:text-lg text-center w-full md:w-2/3">
            Lancarin menawarkan layanan perawatan grease trap profesional untuk memastikan sistem limbah dapur Anda tetap bersih dan berfungsi optimal. Layanan kami meliputi:
          </p>
          <div>
            <SimpleCard_V5>
              <Image
